...
upgrade_menu = pygame.transform.scale(pygame.image.load(os.path.join("upgrade_menu.png")), (125, 60))
upgrade_button = pygame.transform.scale(pygame.image.load(os.path.join("upgrade_btn.png")), (50, 50))
